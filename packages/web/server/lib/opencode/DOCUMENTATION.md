...
- `packages/web/server/lib/opencode/version-policy.js`: Target external OpenCode runtime policy. DevRyan recommends `anomalyco/opencode` v1.15.7 and surfaces the upstream install command while still using the user/system `opencode` binary.
