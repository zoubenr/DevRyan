...
- `opencodeConfig.ts` owns VS Code-side config entity reads/writes and managed agent runtime overlays so saved user-side agent model defaults apply to the local OpenCode process.
