...
type ScrollableOverlayProps = React.HTMLAttributes<HTMLElement> & {
  ...
  disabled?: boolean;
  /**
   * Forwarded to the scrolling element (kept in `...rest`). Set together with
   * a framer-motion `as` component to mark this as a layout scroll container so
   * descendant layout animations account for scroll offset.
   */
