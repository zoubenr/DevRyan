 ...
 *   4. `plan-proposed`       — plan indicator is "proposed"; this is an
 *                              explicit plan-card lifecycle state and wins over
 *                              delayed/stale assistant activity.
...
export const deriveSessionLifecycleStatus = (
  ...
  if (inputs.planIndicatorState === 'proposed') {
