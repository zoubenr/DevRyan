export const settingsDict = {
  ...
  'settings.skills.location.option.userClaude.description': 'Global .claude compatibility location',
  'settings.skills.location.option.projectClaude.label': 'Project / Claude',
  'settings.skills.location.option.projectClaude.description': 'Current project .claude compatibility location',
